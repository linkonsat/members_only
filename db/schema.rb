...
ActiveRecord::Schema[7.0].define(version: 2022_06_16_192135) do
  ...
  create_table "game_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["all_game_id"], name: "index_game_categories_on_all_game_id"
  end
  ...
  create_table "user_games", force: :cascade do |t|
    t.bigint "game_profile_id"
    t.text "title"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_profile_id"], name: "index_user_games_on_game_profile_id"
  end
